                ...
                <Container>
                    <div className="row">
                        <div className="col-md-9">
                            ...
                            <a href="../assets/Resume.pdf" target="_blank">PDF Download</a>
                            ...
                            <p className="mb-3">GitHub: <a href="https://www.linkedin.com/in/spencer-creer-023246109/" target="_blank">spencercreer</a></p>
                        </div>
                        ...
                        <div className="row">
                            <i className="col-md-6 mb-0">Moxtek, Inc.</i>
                        ...
                        <div className="row">
                            <i className="col-md-6 mb-0">Advanced Composites</i>
                        ...
                        <div className="row">
                            <i className="col-md-6 mb-0">New Star Communications Int. Inc</i>
                            <i className="col-md-6 mb-0 align-left-sm align-right-lg">May 2014 to January 2019</i>
                        </div>
                        ...
                        <p><strong>Full-Stack Web Development Diploma</strong></p>
