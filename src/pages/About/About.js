                ...
                <Row>
                    <Col lg={{ span:6, offset: 1}} className="mt-5">
                        <div className="mx-5">
                            ...
                            <p className="lead">I attended Brigham Young University from 2012 to 2018 and graduated with a bachelor's degree in Mechanical Engineering. I also received a minor in German and a minor Global Business and Literacy. I have recently graduated from the full-stack web development bootcamp at the University of Utah.</p>
                            ...
                            <p className="lead">In December 2018, I married my best friend and wife Lyndsey in Gilbert Arizona. Lyndsey graduated from BYU with a bachelor's of arts in Philosopy and a minor in logic. She will be going to law school to become a county prosecutor. We enjoy cooking, exercising, and being outdoors together.
                            </p>
                        </div>
                    </Col>
